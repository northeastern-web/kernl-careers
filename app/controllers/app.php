    ...
    public static function subtitle()
    {
        if (is_singular('tribe_events')) {
            ...
            if (tribe_event_is_multiday()) {
                $event_date = '<i data-feather="clock" class="tc--red --thin"></i> ' . $start_date .' &mdash; '. $end_date;
            } elseif (tribe_event_is_all_day()) {
                $event_date = '<i data-feather="clock" class="tc--red --thin"></i> ' . $start_date .' &bull; All Day';
            } else {
                $event_date = '<i data-feather="clock" class="tc--red --thin"></i> ' . $start_date .' &bull; '. $start_time .' - '. $end_time;
            }
