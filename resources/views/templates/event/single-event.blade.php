    ...
    <div class="col w--1/4@d">
      <div class="card h--auto mb--1">
        <div class="__body pb--1">
          <div class="__title mb--1">{!! \Kernl\Lib\Utility::getTribeDate(get_the_id()) !!}</div>
          <div class="mb--1"><a class="btn --sm" href="?ical"><i data-feather="calendar"></i> Save to Calendar</a></div>
