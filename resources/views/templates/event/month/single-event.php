...
$menu_order   = get_post_field( 'menu_order', $event_id);
...
<div id="tribe-events-event-<?php echo esc_attr( $event_id ); ?>" class="<?php tribe_events_event_classes() ?>
<?= $menu_order == -1 ? ' sticky-event' : ''; ?>" data-tribejson='<?php echo esc_attr( tribe_events_template_data( $post ) ); ?>'>
